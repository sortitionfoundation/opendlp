...
C002,Bob Jones,bob@example.com,42"""
    ...
    def test_import_missing_id_column_raises_error(self, postgres_session_factory, admin_user, test_assembly):
...
EXT001,Alice Smith,alice@example.com"""
    ...
    def test_import_creates_default_config(self, postgres_session_factory, admin_user, test_assembly):
