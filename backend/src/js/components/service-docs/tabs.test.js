...
const EXECUTE_CALLS = [
  ...
  },
  {
    ...
    props: { createRegistrationAssemblyId: "a-1" },
  ...
  },
  {
    ...
    props: { getRegistrationAssemblyId: "a-1" },
  ...
  },
  {
    ...
    params: { assembly_id: "a-1", url_slug: "slug", short_url_slug: "s" },
  },
  {
    factory: serviceDocsRegistration,
    method: "executeUpdateRegistrationHtml",
    props: { updateHtmlAssemblyId: "a-1", updateHtmlContent: "<form></form>" },
    service: "update_registration_page_html",
    params: { assembly_id: "a-1", form_html: "<form></form>" },
  },
  {
    factory: serviceDocsRegistration,
    method: "executePublishRegistrationPage",
    props: { publishAssemblyId: "a-1" },
  ...
  },
  {
    ...
    params: { assembly_id: "a-1", template_id: "t-1" },
  },
  {
    factory: serviceDocsEmails,
