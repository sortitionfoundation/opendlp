...
def service_docs_execute() -> ResponseReturnValue:
    ...
    try:
        ...
        return jsonify({
            "status": "error",
            "error": "An internal error occurred while executing the service - review the flask console log.",
...
SERVICE_RESPONSE_KEYS: dict[str, str] = {
    ...
    "list_registration_pages": "list_registration_pages",
    "duplicate_registration_page": "duplicate_registration_page",
    "delete_registration_page": "delete_registration_page",
