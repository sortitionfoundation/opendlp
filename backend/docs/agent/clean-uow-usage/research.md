# Clean up UnitOfWork usage - research

Background, evidence and options analysis. **The plan of work is in
[plan.md](plan.md)**; this file is the reasoning behind it and the source of its
figures.
